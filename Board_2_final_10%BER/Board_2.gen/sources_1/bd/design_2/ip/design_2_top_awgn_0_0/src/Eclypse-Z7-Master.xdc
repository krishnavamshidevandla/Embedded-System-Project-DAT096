## Eclypse Z7 Rev. B.0 - project-specific constraint file
## Active ports match current top-level entity:
##   clk
##   btn[1:0]
##   led0_b, led0_r, led1_b, led1_g, led1_r
##   ja[7:0], jb[7:0]
...
########################################################################
## Unused for current top-level - kept here commented for later use
########################################################################

## Legacy / alternate ports
#set_property -dict { PACKAGE_PIN C17   IOSTANDARD LVCMOS33 } [get_ports { reset }]; # old mapping
#set_property -dict { PACKAGE_PIN B16   IOSTANDARD LVCMOS33 } [get_ports { valid }]; # old mapping
...
## Miscellaneous
#set_property -dict { PACKAGE_PIN B22   IOSTANDARD LVCMOS33 } [get_ports { mcu_rsvd[0] }]; #IO_L18N_T2_AD13N Sch=mcu_rsvd[0]
#set_property -dict { PACKAGE_PIN B21   IOSTANDARD LVCMOS33 } [get_ports { mcu_rsvd[1] }]; #IO_L18P_T2_AD13P Sch=mcu_rsvd[1]