...
-- Date        : Wed May 20 14:39:26 2026
-- Host        : FY-6302-10 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               z:/DAT096/DAT096-Qian/Embedded-System-Project-DAT096-Qians-branch/Board_1/Board_1/Board_2.gen/sources_1/bd/design_2/ip/design_2_adc_bit_decoder_0_0/design_2_adc_bit_decoder_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of design_2_adc_bit_decoder_0_0_adc_bit_decoder is
  ...
  signal dac_data0_in : STD_LOGIC_VECTOR ( 14 to 14 );
  ...
  signal \dac_data[14]_i_7_n_0\ : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \dac_data[13]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \dac_data[14]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \dac_data[14]_i_4\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \dac_data[14]_i_6\ : label is "soft_lutpair0";
begin
  bit_out <= \^bit_out\;
...
bit_q_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"F777"
    )
        port map (
...
\dac_data[13]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"0E"
    )
        port map (
...
\dac_data[14]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"F2"
    )
        port map (
...
\dac_data[14]_i_3\: unisim.vcomponents.LUT6
    generic map(
      ...
      I0 => t_valid,
      I1 => t_data(13),
      I2 => \dac_data[14]_i_6_n_0\,
      I3 => \dac_data[14]_i_7_n_0\,
      I4 => t_data(11),
      I5 => t_data(12),
      O => dac_data0_in(14)
    );
\dac_data[14]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000001"
    )
        port map (
...
\dac_data[14]_i_7\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"57FFFFFF"
    )
        port map (
...
architecture STRUCTURE of design_2_adc_bit_decoder_0_0 is
  ...
  signal \^dac_data\ : STD_LOGIC_VECTOR ( 12 downto 11 );
...
begin
  ...
  dac_data(16) <= \<const0>\;
  dac_data(15) <= \<const0>\;
  dac_data(14) <= \^dac_data\(11);
  dac_data(13) <= \^dac_data\(12);
  dac_data(12 downto 11) <= \^dac_data\(12 downto 11);
  dac_data(10) <= \^dac_data\(11);
  dac_data(9) <= \^dac_data\(11);
  dac_data(8) <= \^dac_data\(11);
  dac_data(7) <= \^dac_data\(11);
