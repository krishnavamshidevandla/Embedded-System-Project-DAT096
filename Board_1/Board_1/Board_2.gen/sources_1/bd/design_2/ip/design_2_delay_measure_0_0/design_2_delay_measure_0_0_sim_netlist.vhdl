...
--               c:/Users/qianzha/Desktop/Embedded-System-Project-DAT096/Board_1/Board_1/Board_2.gen/sources_1/bd/design_2/ip/design_2_delay_measure_0_0/design_2_delay_measure_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of design_2_delay_measure_0_0_delay_measure is
  ...
  signal \delay_reg0__0\ : STD_LOGIC;
  signal match_prev : STD_LOGIC;
  signal match_prev_i_1_n_0 : STD_LOGIC;
  signal measuring_i_1_n_0 : STD_LOGIC;
  signal p_0_in : STD_LOGIC;
  signal \^start\ : STD_LOGIC;
  signal tx_prev : STD_LOGIC;
  signal tx_prev_i_1_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of match_prev_i_1 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of tx_prev_i_1 : label is "soft_lutpair0";
begin
  start <= \^start\;
...
delay_reg0: unisim.vcomponents.LUT3
    generic map(
      INIT => X"20"
    )
        port map (
...
match_prev_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
match_prev_reg: unisim.vcomponents.FDRE
    generic map(
      ...
      C => clk,
      CE => '1',
      D => match_prev_i_1_n_0,
      Q => match_prev,
      R => '0'
    );
measuring_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"F0F000F020202020"
    )
        port map (
      I0 => tx_start,
      I1 => tx_prev,
...
tx_prev_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
