...
architecture STRUCTURE of design_2_prbs_axis_master_32_0_0 is
  ...
  signal \^m_axis_tdata\ : STD_LOGIC_VECTOR ( 14 downto 3 );
...
begin
  ...
  m_axis_tdata(13) <= \^m_axis_tdata\(11);
  m_axis_tdata(12) <= \^m_axis_tdata\(9);
  m_axis_tdata(11) <= \^m_axis_tdata\(11);
  m_axis_tdata(10) <= \^m_axis_tdata\(11);
  m_axis_tdata(9) <= \^m_axis_tdata\(9);
  m_axis_tdata(8) <= \^m_axis_tdata\(9);
  m_axis_tdata(7) <= \^m_axis_tdata\(9);
