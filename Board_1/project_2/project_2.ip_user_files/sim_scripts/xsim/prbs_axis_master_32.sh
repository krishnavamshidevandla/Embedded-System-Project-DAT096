...
#
# Script generated by Vivado on Wed Feb 18 16:36:34 +0100 2026
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : prbs_axis_master_32.sh
...
#
# Usage        : prbs_axis_master_32.sh
#                prbs_axis_master_32.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                prbs_axis_master_32.sh [-reset_run]
#                prbs_axis_master_32.sh [-reset_log]
#                prbs_axis_master_32.sh [-help]
#
...
# script info
echo -e "prbs_axis_master_32.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./prbs_axis_master_32.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L secureip --snapshot prbs_axis_master_32 xil_defaultlib.prbs_axis_master_32 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim prbs_axis_master_32 -key {Behavioral:sim_1:Functional:prbs_axis_master_32} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb prbs_axis_master_32.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./prbs_axis_master_32.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: prbs_axis_master_32.sh [-help]\n\
Usage: prbs_axis_master_32.sh [-step]\n\
Usage: prbs_axis_master_32.sh [-lib_map_path]\n\
Usage: prbs_axis_master_32.sh [-reset_run]\n\
Usage: prbs_axis_master_32.sh [-reset_log]\n\
Usage: prbs_axis_master_32.sh [-keep_index]\n\
Usage: prbs_axis_master_32.sh [-noclean_files]\n\n\
