...
--               z:/DAT096/DAT096-Qian/Embedded-System-Project-DAT096-Qians-branch/Board_1/Board_1/Board_2.gen/sources_1/bd/design_2/ip/design_2_delay_96_cycles_0_0/design_2_delay_96_cycles_0_0_sim_netlist.vhdl
-- Design      : design_2_delay_96_cycles_0_0
...
entity design_2_delay_96_cycles_0_0_delay_96_cycles is
  port (
    dout : out STD_LOGIC;
    clk : in STD_LOGIC;
    din : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME of design_2_delay_96_cycles_0_0_delay_96_cycles : entity is "delay_96_cycles";
end design_2_delay_96_cycles_0_0_delay_96_cycles;

architecture STRUCTURE of design_2_delay_96_cycles_0_0_delay_96_cycles is
  signal p_0_in : STD_LOGIC;
  signal p_1_in : STD_LOGIC_VECTOR ( 199 downto 1 );
begin
\delay[199]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\delay_reg[192]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\delay_reg[193]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\delay_reg[194]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\delay_reg[195]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\delay_reg[196]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\delay_reg[197]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\delay_reg[198]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\delay_reg[199]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_2_delay_96_cycles_0_0 is
  port (
    clk : in STD_LOGIC;
    rst : in STD_LOGIC;
    din : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of design_2_delay_96_cycles_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_2_delay_96_cycles_0_0 : entity is "design_2_delay_96_cycles_0_0,delay_96_cycles,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_2_delay_96_cycles_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of design_2_delay_96_cycles_0_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of design_2_delay_96_cycles_0_0 : entity is "delay_96_cycles,Vivado 2024.2";
end design_2_delay_96_cycles_0_0;

architecture STRUCTURE of design_2_delay_96_cycles_0_0 is
...
begin
U0: entity work.design_2_delay_96_cycles_0_0_delay_96_cycles
     port map (
      clk => clk,
      din => din,
      dout => dout,
