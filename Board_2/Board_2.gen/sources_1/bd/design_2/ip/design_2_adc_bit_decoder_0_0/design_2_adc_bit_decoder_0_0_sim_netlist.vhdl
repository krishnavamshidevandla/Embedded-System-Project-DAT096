...
--               c:/Users/qianzha/Desktop/Board_2/Board_2/Board_2.gen/sources_1/bd/design_2/ip/design_2_adc_bit_decoder_0_0/design_2_adc_bit_decoder_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of design_2_adc_bit_decoder_0_0_adc_bit_decoder is
  ...
  signal \dac_data[12]_i_9_n_0\ : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \dac_data[10]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \dac_data[12]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \dac_data[12]_i_4\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \dac_data[12]_i_6\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \dac_data[12]_i_7\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \dac_data[12]_i_9\ : label is "soft_lutpair1";
begin
  bit_out <= \^bit_out\;
...
\dac_data[10]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"F2"
    )
        port map (
...
\dac_data[12]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"0E"
    )
        port map (
...
\dac_data[12]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"44444000"
    )
        port map (
...
\dac_data[12]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"F8"
    )
        port map (
...
\dac_data[12]_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
\dac_data[12]_i_8\: unisim.vcomponents.LUT6
    generic map(
...
\dac_data[12]_i_9\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"777F"
    )
        port map (
