...
//               c:/Users/devandla/Desktop/Embedded-System-Project-DAT096/Board_2/Board_2/Board_2.gen/sources_1/bd/design_2/ip/design_2_ZmodAWGController_0_0/design_2_ZmodAWGController_0_0_stub.v
...
module design_2_ZmodAWGController_0_0(SysClk100, DAC_InIO_Clk, DAC_Clk, aRst_n, 
...
/* synthesis syn_force_seq_prim="DAC_Clk" */;
  (* x_interface_info = "xilinx.com:signal:clock:1.0 SysClk100 CLK" *) (* x_interface_mode = "slave SysClk100" *) (* x_interface_parameter = "XIL_INTERFACENAME SysClk100, ASSOCIATED_BUSIF SPI_IAP_RX:SPI_IAP_TX, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN design_2_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0" *) input SysClk100 /* synthesis syn_isclock = 1 */;
  (* x_interface_info = "xilinx.com:signal:clock:1.0 DAC_InIO_Clk CLK" *) (* x_interface_mode = "slave DAC_InIO_Clk" *) (* x_interface_parameter = "XIL_INTERFACENAME DAC_InIO_Clk, ASSOCIATED_BUSIF InputDataStream, FREQ_HZ 50000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN design_2_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0" *) input DAC_InIO_Clk /* synthesis syn_isclock = 1 */;
  (* x_interface_info = "xilinx.com:signal:clock:1.0 DAC_Clk CLK" *) (* x_interface_mode = "slave DAC_Clk" *) (* x_interface_parameter = "XIL_INTERFACENAME DAC_Clk, FREQ_HZ 50000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN /clk_wiz_0_clk_out1, INSERT_VIP 0" *) input DAC_Clk /* synthesis syn_isclock = 1 */;
