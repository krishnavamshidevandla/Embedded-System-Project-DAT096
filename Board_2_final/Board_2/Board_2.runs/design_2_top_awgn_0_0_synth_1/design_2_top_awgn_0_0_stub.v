...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk, reset, snr_sel, valid, awgn_re_dbg, 
  awgn_im_dbg)
/* synthesis syn_black_box black_box_pad_pin="reset,snr_sel[1:0],valid,awgn_re_dbg[9:0],awgn_im_dbg[9:0]" */
/* synthesis syn_force_seq_prim="clk" */;
  ...
  input [1:0]snr_sel;
  output valid;
  output [9:0]awgn_re_dbg;
  output [9:0]awgn_im_dbg;
endmodule
