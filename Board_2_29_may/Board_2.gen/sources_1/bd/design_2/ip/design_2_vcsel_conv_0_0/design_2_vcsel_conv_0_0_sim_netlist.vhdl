...
architecture STRUCTURE of design_2_vcsel_conv_0_0_vcsel_conv is
  signal final : STD_LOGIC_VECTOR ( 13 downto 0 );
  signal \final[11]_i_2_n_0\ : STD_LOGIC;
  signal \final[3]_i_2_n_0\ : STD_LOGIC;
  signal \final[3]_i_3_n_0\ : STD_LOGIC;
  signal \final[3]_i_4_n_0\ : STD_LOGIC;
  signal \final[3]_i_5_n_0\ : STD_LOGIC;
  ...
  signal \final_reg[3]_i_1_n_0\ : STD_LOGIC;
  signal \final_reg[3]_i_1_n_1\ : STD_LOGIC;
  signal \final_reg[3]_i_1_n_2\ : STD_LOGIC;
  signal \final_reg[3]_i_1_n_3\ : STD_LOGIC;
  ...
  attribute ADDER_THRESHOLD of \final_reg[3]_i_1\ : label is 35;
...
\final[3]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\final[3]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\final[3]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\final[3]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\final_reg[11]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 1) => t_data(11 downto 9),
      S(0) => \final[11]_i_2_n_0\
    );
...
\final_reg[13]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 2) => B"00",
      S(1 downto 0) => t_data(13 downto 12)
    );
...
\final_reg[3]_i_1\: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => \final_reg[3]_i_1_n_0\,
      CO(2) => \final_reg[3]_i_1_n_1\,
      CO(1) => \final_reg[3]_i_1_n_2\,
      CO(0) => \final_reg[3]_i_1_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => noise_data(3 downto 0),
      O(3 downto 0) => p_0_in(3 downto 0),
      S(3) => \final[3]_i_2_n_0\,
      S(2) => \final[3]_i_3_n_0\,
      S(1) => \final[3]_i_4_n_0\,
      S(0) => \final[3]_i_5_n_0\
    );
...
architecture STRUCTURE of design_2_vcsel_conv_0_0 is
  ...
  signal \^dac_data\ : STD_LOGIC_VECTOR ( 15 downto 2 );
...
begin
  ...
  dac_data(17) <= \<const0>\;
  dac_data(16) <= \<const0>\;
  dac_data(15 downto 2) <= \^dac_data\(15 downto 2);
  dac_data(1) <= \<const0>\;
  dac_data(0) <= \<const0>\;
  t_valid <= \<const1>\;
...
U0: entity work.design_2_vcsel_conv_0_0_vcsel_conv
     port map (
      clk => clk,
      dac_data(13 downto 0) => \^dac_data\(15 downto 2),
      noise_data(8 downto 0) => noise_data(8 downto 0),
