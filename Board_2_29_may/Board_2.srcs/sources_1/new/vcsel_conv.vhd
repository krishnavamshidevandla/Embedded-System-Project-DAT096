...
entity vcsel_conv is
  generic(
    ...
    MAX_CODE  : natural  := 10192;
    MIN_CODE  : natural  := 6192;
...
architecture rtl of vcsel_conv is
  ...
  signal noise_u  : unsigned(8 downto 0);
...
--          code_u <= MIN;
--        end if;
       final <= noise_u + unsigned(t_data);
        dac_data <= (31 downto 16 => '0') & std_logic_vector(final) & "00";
      end if;
  end process;
