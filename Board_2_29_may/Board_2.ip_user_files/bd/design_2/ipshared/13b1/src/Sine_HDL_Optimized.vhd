-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\whdlAWGNGenerator\Sine_HDL_Optimized.vhd
...
-- Source Path: whdlAWGNGenerator/AWGNGenerator/GaussianNoiseWithUnitVar/SinCos/Sine HDL Optimized
-- Hierarchy Level: 3
-- Model version: 2.1
-- 
-- -------------------------------------------------------------
...
BEGIN
  ...
  Sine <= Negate_out1 WHEN LTEp50_out1 = '0' ELSE
      Look_Up_Table_out1;
