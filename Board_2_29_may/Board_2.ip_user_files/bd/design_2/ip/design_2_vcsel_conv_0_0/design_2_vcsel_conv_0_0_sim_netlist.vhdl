...
architecture STRUCTURE of design_2_vcsel_conv_0_0_vcsel_conv is
  signal code_u : STD_LOGIC_VECTOR ( 12 downto 4 );
  signal \code_u[10]_i_1_n_0\ : STD_LOGIC;
  signal \code_u[10]_i_2_n_0\ : STD_LOGIC;
  signal \code_u[12]_i_1_n_0\ : STD_LOGIC;
  signal \code_u[12]_i_2_n_0\ : STD_LOGIC;
  signal \code_u[12]_i_3_n_0\ : STD_LOGIC;
  signal \code_u[12]_i_4_n_0\ : STD_LOGIC;
  signal \code_u[12]_i_5_n_0\ : STD_LOGIC;
  signal \code_u[12]_i_6_n_0\ : STD_LOGIC;
  signal \code_u[12]_i_7_n_0\ : STD_LOGIC;
  ...
  signal \final[13]_i_2_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \code_u[12]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \code_u[12]_i_3\ : label is "soft_lutpair1";
...
\code_u[12]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\code_u[12]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\code_u[12]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\code_u[12]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\code_u[12]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\code_u[12]_i_6\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFA8"
    )
        port map (
...
\code_u[12]_i_7\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
\final[13]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
U0: entity work.design_2_vcsel_conv_0_0_vcsel_conv
     port map (
      ...
      noise_data(12 downto 0) => noise_data(12 downto 0),
